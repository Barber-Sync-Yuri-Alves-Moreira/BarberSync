"""
Django settings for barbersync_project project.
...
TIME_ZONE = 'America/Sao_Paulo' # <-- Mudei para nosso fuso horário
...
STATIC_URL = 'static/'
# (Vamos adicionar o STATIC_ROOT para garantir que o Jazzmin (CSS) funcione)
